...
f_plus = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/no_deriv/f0_plus.npy')
f_minus = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/no_deriv/f0_minus.npy')
...
for point in point_list:
    #np.save(f'/home2/victor.diaz/nnp/deriv/data/0/D7/D7_U_r={point[0]}_Q={point[1]}', D7_U(point[0],I,Q_vals[point[1]],hD7))
    np.save(f'/home2/victor.diaz/nnp/deriv/data/0/D8/D8_U_r={point[0]}_Q={point[1]}', D8_U(point[0],I,Q_vals[point[1]],hD8))
    #np.save(f'/home2/victor.diaz/nnp/deriv/data/0/D9/D9_U_r={point[0]}_Q={point[1]}', D9_U(point[0],I,Q_vals[point[1]],hD9))
