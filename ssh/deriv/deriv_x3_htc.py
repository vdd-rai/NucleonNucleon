...
### read f(r) values # 0 model

# plus / minus : x sign
# p / m : hD sign

f_plus_p_x1 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D1/f0_plus_p_x1.npy')
f_plus_m_x1 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D1/f0_plus_m_x1.npy')
f_minus_p_x1 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D1/f0_minus_p_x1.npy') 
f_minus_m_x1 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D1/f0_minus_m_x1.npy') 

f_plus_p_x2 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D2/f0_plus_p_x2.npy')
f_plus_m_x2 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D2/f0_plus_m_x2.npy')
f_minus_p_x2 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D2/f0_minus_p_x2.npy')
f_minus_m_x2 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D2/f0_minus_m_x2.npy')

f_plus_p_x3 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D3/f0_plus_p_x3.npy')
f_plus_m_x3 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D3/f0_plus_m_x3.npy')
f_minus_p_x3 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D3/f0_minus_p_x3.npy')
f_minus_m_x3 = np.load('/home2/victor.diaz/nnp/profile_f/interp/data/0/D3/f0_minus_m_x3.npy')
...
for idx,point in enumerate(point_list):
    #np.save(f'/home2/victor.diaz/nnp/deriv/data/0/D1/D1_U_r={point[0]}_Q={point[1]}', D1_U(point[0],I,Q_vals[point[1]],hD1))
    #np.save(f'/home2/victor.diaz/nnp/deriv/data/0/D2/D2_U_r={point[0]}_Q={point[1]}', D2_U(point[0],I,Q_vals[point[1]],hD2))
    np.save(f'/home2/victor.diaz/nnp/deriv/data/0/D3/D3_U_r={point[0]}_Q={point[1]}', D3_U(point[0],I,Q_vals[point[1]],hD3))
