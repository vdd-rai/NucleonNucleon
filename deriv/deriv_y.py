...
for i,point in enumerate(point_list):
    t0 = time.time()
    np.save(f'/home/velni/phd/w/tfm/py/deriv/data/0/d1/d1_U_r={point[0]}_Q={point[1]}', d1_U(point[0],I,Q_vals[point[1]],hD))
    #np.save(f'/home/velni/phd/w/tfm/py/deriv/data/0/d2/d2_U_r={point[0]}_Q={point[1]}', d2_U(point[0],I,Q_vals[point[1]],hD))
    #np.save(f'/home/velni/phd/w/tfm/py/deriv/data/0/d3/d3_U_r={point[0]}_Q={point[1]}', d3_U(point[0],I,Q_vals[point[1]],hD))
    stept = time.time() - t0
