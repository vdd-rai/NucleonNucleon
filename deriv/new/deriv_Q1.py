...
def D4_U(r_index,Q1p,Q2,hD):
    D4U_vals = np.zeros((len(y1),len(y2),len(y3),4),dtype=complex)
    for idx in idx_list:
...
def D5_U(r_index,Q1p,Q2,hD):
    D5U_vals = np.zeros((len(y1),len(y2),len(y3),4),dtype=complex)
    for idx in idx_list:
...
def D6_U(r_index,Q1p,Q2,hD):
    D6U_vals = np.zeros((len(y1),len(y2),len(y3),4),dtype=complex)
    for idx in idx_list:
