...
f_plus_p_x1 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D1/plus/f0_plus_p_x1.npy')
f_plus_m_x1 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D1/plus/f0_plus_m_x1.npy')
f_minus_p_x1 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D1/minus/f0_minus_p_x1.npy') 
f_minus_m_x1 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D1/minus/f0_minus_m_x1.npy') 

f_plus_p_x2 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D2/plus/f0_plus_p_x2.npy')
f_plus_m_x2 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D2/plus/f0_plus_m_x2.npy')
f_minus_p_x2 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D2/minus/f0_minus_p_x2.npy')
f_minus_m_x2 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D2/minus/f0_minus_m_x2.npy')

f_plus_p_x3 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D3/plus/f0_plus_p_x3.npy')
f_plus_m_x3 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D3/plus/f0_plus_m_x3.npy')
f_minus_p_x3 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D3/minus/f0_minus_p_x3.npy')
f_minus_m_x3 = np.load('/home/velni/phd/w/tfm/py/profile_f/interp/data/0/D3/minus/f0_minus_m_x3.npy')
...
def D1_U(r_index,Q1,Q2,hD):
    D1U_vals = np.zeros((len(y1),len(y2),len(y3),4),dtype=complex)
    for idx in idx_list:
...
def D3_U(r_index,Q1,Q2,hD):
    D3U_vals = np.zeros((len(y1),len(y2),len(y3),4),dtype=complex)
    for idx in idx_list:
