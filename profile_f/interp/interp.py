...
for r in r_vals: # for each r
        ...
        temp_f = [np.interp( np.linalg.norm( np.array([y1[idx[0]]+hD,y2[idx[1]],y3[idx[2]]]) + np.array([0.,0.,r])/2. ),r0,f0 ) for idx in idx_list] # interpolat>
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d1/plus/f0_plus_p_y1', f0_plus_p_y1)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d1/plus/f0_plus_m_y1', f0_plus_m_y1)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d1/minus/f0_minus_p_y1', f0_minus_p_y1)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d1/minus/f0_minus_m_y1', f0_minus_m_y1)
...
for r in r_vals: # for each r
        matrix_f = np.zeros((50,50,50)) # generate a 3D matrix of zeros to store f values
        temp_f = [np.interp( np.linalg.norm( np.array([y1[idx[0]],y2[idx[1]]+hD,y3[idx[2]]]) + np.array([0.,0.,r])/2. ),r0,f0 ) for idx in idx_list] # interpolat>
        for f_idx,idx in enumerate(idx_list): # run over indices
                matrix_f[idx[0]][idx[1]][idx[2]] = temp_f[f_idx] # save each f value on the corresponding 3D point
        f0_plus_p_y2.append(matrix_f) # save matrix for r value
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d2/plus/f0_plus_p_y2', f0_plus_p_y2)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d2/plus/f0_plus_m_y2', f0_plus_m_y2)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d2/minus/f0_minus_p_y2', f0_minus_p_y2)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d2/minus/f0_minus_m_y2', f0_minus_m_y2)
...
for r in r_vals: # for each r
        matrix_f = np.zeros((50,50,50)) # generate a 3D matrix of zeros to store f values
        temp_f = [np.interp( np.linalg.norm( np.array([y1[idx[0]],y2[idx[1]],y3[idx[2]]+hD]) + np.array([0.,0.,r])/2. ),r0,f0 ) for idx in idx_list] # interpolat>
        for f_idx,idx in enumerate(idx_list): # run over indices
                matrix_f[idx[0]][idx[1]][idx[2]] = temp_f[f_idx] # save each f value on the corresponding 3D point
        f0_plus_p_y3.append(matrix_f) # save matrix for r value
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d3/plus/f0_plus_p_y3', f0_plus_p_y3)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d3/plus/f0_plus_m_y3', f0_plus_m_y3)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d3/minus/f0_minus_p_y3', f0_minus_p_y3)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/d3/minus/f0_minus_m_y3', f0_minus_m_y3)
...
for r in r_vals: # for each r
        matrix_f = np.zeros((50,50,50)) # generate a 3D matrix of zeros to store f values
        temp_f = [np.interp( np.linalg.norm( np.array([y1[idx[0]],y2[idx[1]],y3[idx[2]]]) + np.array([hD,0.,r])/2. ),r0,f0 ) for idx in idx_list] # interpolat>
        for f_idx,idx in enumerate(idx_list): # run over indices
                matrix_f[idx[0]][idx[1]][idx[2]] = temp_f[f_idx] # save each f value on the corresponding 3D point
        f0_plus_p_x1.append(matrix_f) # save matrix for r value
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D1/plus/f0_plus_p_x1', f0_plus_p_x1)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D1/plus/f0_plus_m_x1', f0_plus_m_x1)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D1/minus/f0_minus_p_x1', f0_minus_p_x1)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D1/minus/f0_minus_m_x1', f0_minus_m_x1)
...
for r in r_vals: # for each r
        matrix_f = np.zeros((50,50,50)) # generate a 3D matrix of zeros to store f values
        temp_f = [np.interp( np.linalg.norm( np.array([y1[idx[0]],y2[idx[1]],y3[idx[2]]]) + np.array([0.,hD,r])/2. ),r0,f0 ) for idx in idx_list] # interpolat>
        for f_idx,idx in enumerate(idx_list): # run over indices
                matrix_f[idx[0]][idx[1]][idx[2]] = temp_f[f_idx] # save each f value on the corresponding 3D point
        f0_plus_p_x2.append(matrix_f) # save matrix for r value
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D2/plus/f0_plus_p_x2', f0_plus_p_x2)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D2/plus/f0_plus_m_x2', f0_plus_m_x2)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D2/minus/f0_minus_p_x2', f0_minus_p_x2)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D2/minus/f0_minus_m_x2', f0_minus_m_x2)
...
for r in r_vals: # for each r
        matrix_f = np.zeros((50,50,50)) # generate a 3D matrix of zeros to store f values
        temp_f = [np.interp( np.linalg.norm( np.array([y1[idx[0]],y2[idx[1]],y3[idx[2]]]) + np.array([0.,0.,r+hD])/2. ),r0,f0 ) for idx in idx_list] # interpolat>
        for f_idx,idx in enumerate(idx_list): # run over indices
                matrix_f[idx[0]][idx[1]][idx[2]] = temp_f[f_idx] # save each f value on the corresponding 3D point
        f0_plus_p_x3.append(matrix_f) # save matrix for r value
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D3/plus/f0_plus_p_x3', f0_plus_p_x3)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D3/plus/f0_plus_m_x3', f0_plus_m_x3)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D3/minus/f0_minus_p_x3', f0_minus_p_x3)
...
np.save('/home/velni/Escritorio/TFM/py/profile_f/interp/data/0/D3/minus/f0_minus_m_x3', f0_minus_m_x3)
