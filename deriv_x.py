...
def D1U_p_mass(coord,r_index,Q1,Q2,hD):
    ...
    f_p = fm_plus_p_x1[r_index][coord[0]][coord[1]][coord[2]]
    f_m = fm_minus_p_x1[r_index][coord[0]][coord[1]][coord[2]]
...
def D1U_m_mass(coord,r_index,Q1,Q2,hD):
    ...
    f_p = fm_plus_m_x1[r_index][coord[0]][coord[1]][coord[2]]
    f_m = fm_minus_m_x1[r_index][coord[0]][coord[1]][coord[2]]
...
def D2U_p_mass(coord,r_index,Q1,Q2,hD):
    ...
    f_p = fm_plus_p_x2[r_index][coord[0]][coord[1]][coord[2]]
    f_m = fm_minus_p_x2[r_index][coord[0]][coord[1]][coord[2]]
...
def D2U_m_mass(coord,r_index,Q1,Q2,hD):
    ...
    f_p = fm_plus_m_x2[r_index][coord[0]][coord[1]][coord[2]]
    f_m = fm_minus_m_x2[r_index][coord[0]][coord[1]][coord[2]]
...
def D3U_p_mass(coord,r_index,Q1,Q2,hD):
    ...
    f_p = fm_plus_p_x3[r_index][coord[0]][coord[1]][coord[2]]
    f_m = fm_minus_p_x3[r_index][coord[0]][coord[1]][coord[2]]
...
def D3U_m_mass(coord,r_index,Q1,Q2,hD):
    ...
    f_p = fm_plus_m_x3[r_index][coord[0]][coord[1]][coord[2]]
    f_m = fm_minus_m_x3[r_index][coord[0]][coord[1]][coord[2]]
